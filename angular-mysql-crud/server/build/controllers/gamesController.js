...
class GamesController {
    ...
    create(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield database_1.default.query('INSERT INTO games set ?', [req.body]); // NOTE: todas las consultas a BBDD son eventos asincronos y llevan su timepo, esto se gestiona mediante las funciones async await ()
